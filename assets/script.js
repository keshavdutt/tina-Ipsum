;(function($) {
	...
	var quotes = [
		...
		"Put it on a t-shirt, Jimmy Jr, I don't want to hear it.",
		"A pants-off. For me?",
		"Yeah it's an acquired taste. That I just acquired.",
		"Sometimes with Jimmy Jr, I don't know what to say. But now I don't know what not to say and it's like okay guys, who can get to my mouth first?",
		"My crotch is itchy.",
		"I'm just not sure if I'll be any good on the grill with one free hand.",
		"Now my rash smells like bacon. But it doesn't itch anymore.",
		"Drop the towel.",
		"My bra's chafing me.",
		"It's a mating list for when the world ends. Can I get your email?",
